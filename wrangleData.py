...
twoDCounties = ['G0100210', 'G0100270', 'G0100390', 'G0100070', 'G0100310', 'G0100150', 'G0100170', 'G0100230', 'G0100410', 'G0100370', 'G0100290', 'G0100010']
threeDCounties = ['G0100050', 'G0100750', 'G0100490', 'G0100430', 'G0100570', 'G0100610', 'G0100510', 'G0100250', 'G0101230', 'G0100830', 'G0101250', 'G0100670']
...
def main():
    ...
    for county in twoDCounties:
        ...
        result = db.aqua_sites.aggregate(pipeline)
        twoDResults.append({
                ...
                'pipeline': [
                    ...
                    },
                    {
                        '$match': {
                            '$expr': {
                                '$eq': [
                                    '$measurement_name', 'Temperature (Deg C)'
                                ]
                            }
                        }
                    },
